{% include "posprice1/pos_price_app/page/posprice/onscan.js" %}
frappe.pages['posprice'].on_page_load = function (wrapper) {
	...
	this.page.$posprice = new frappe.Posprice.Posprice(this.page);
